    ...
    'apiskeletons-oauth2-doctrine' => array(
        'default' => array(
            ...
            'dynamic_mapping' => array(
                ...
                'client_entity' => array(
                    'entity' => 'Application\Entity\OAuth2\Client',
                    'field' => 'client',
                ...
                'access_token_entity' => array(
                    'entity' => 'Application\Entity\OAuth2\AccessToken',
                    'field' => 'accessToken',
                    'additional_mapping_data' => array(
                        'joinColumns' => array(
                            array(
                ...
                'authorization_code_entity' => array(
                    'entity' => 'Application\Entity\OAuth2\AuthorizationCode',
                ...
                'refresh_token_entity' => array(
                    'entity' => 'Application\Entity\OAuth2\RefreshToken',
                    'field' => 'refreshToken',
                    'additional_mapping_data' => array(
                        'joinColumns' => array(
                            array(
            ...
            'mapping' => array(
                ...
                'Client' => array(
                    ...
                    'mapping' => array(
                        ...
                        'scope' => array(
                            'type' => 'collection',
                            'name' => 'scope',
                            'entity' => 'Application\Entity\OAuth2\Scope',
                            'mapper' => 'Scope',
                        ),
                        'user_id' => array(
                            'type' => 'relation',
                ...
                'Jwt' => array(
                    'entity' => 'Application\Entity\OAuth2\Jwt',
                    'mapping' => array(
                        'subject' => array(
                            'type' => 'field',
                            'name' => 'subject',
                ...
                'Jti' => array(
                    'entity' => 'Application\Entity\OAuth2\Jti',
                    'mapping' => array(
                        'subject' => array(
                            'type' => 'field',
                            'name' => 'subject',
                ...
                'PublicKey' => array(
                    'entity' => 'Application\Entity\OAuth2\PublicKey',
                    'mapping' => array(
                        'public_key' => array(
                            'type' => 'field',
                            'name' => 'publicKey',
